...
knitr::include_graphics("images/27-benthic_habitat_quality/ruppia_lifecycle.png")
```
...
importance (Figure \@fig:coorongmap). The growth of the keystone seagrass species *Ruppia
...
the `aed_habitat` module (examples are shown in Figure \@fig:Gen2-HSIflower and \@fig:Gen2-HSIsexual). Refer to [CDM manual](https://aquaticecodynamics.github.io/cdm-science/habitat-modelling.html)
