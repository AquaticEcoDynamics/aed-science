...
plot <- ggplot(data.frame(x = c(0, 40)), aes(x = x)) +
  geom_path(aes(colour="red"), stat="function", fun=a_plot) +
  geom_path(aes(colour="blue"), stat="function", fun=b_plot) +
  geom_path(aes(colour="green"), stat="function", fun=c_plot) +
  geom_path(aes(colour="yellow"), stat="function", fun=d_plot) +
  geom_path(aes(colour="orange"), stat="function", fun=e_plot) +
  geom_path(aes(colour="pink"), stat="function", fun=f_plot) +
  xlab("Temperature (˚C)") + ylab(bquote('k[d](T,0,7)(day^-1)'))
