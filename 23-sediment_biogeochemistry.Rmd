...
OMApproach_tab <- read_xlsx("tables/23-sediment_biogeochemistry/UserManual.xlsx", sheet="OMApproach")
 ...
 scroll_box(width = "40em", height = "25em",fixed_thead = FALSE)
```
</center>
...
```{r NModel-1, echo=FALSE, fig.cap=" wqwqwq", fig.show="hold", out.width="35%" ,fig.align='center'}
...
These reactions interact as shown in figure \@ref(fig:NModel-2). 

<center>

```{r NModel-2, echo=FALSE, fig.cap=" wqwqwq", fig.show="hold", out.width="85%" ,fig.align='center'}
knitr::include_graphics("images/23-sediment_biogeochemistry/OMSetup/NModel2.png")
```

</center>

The rate equations are as shown in table \@ref(tab:NRate-table). 
...
NRates_tab <- read_xlsx("tables/23-sediment_biogeochemistry/UserManual.xlsx", sheet="NRates")
  kable(NRates_tab[,1:2],"html", escape = F, align = "c"
        , caption = "wqwqwqwqwq",bootstrap_options = "hover")%>%
 ...
 scroll_box(width = "40em", height = "40em",fixed_thead = FALSE)
```
</center>
