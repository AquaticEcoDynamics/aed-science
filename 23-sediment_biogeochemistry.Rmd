...
OMModel_Groups <- unique(OMModel_tab$Group)
 ...
 scroll_box(width = "770px", height = "30em",fixed_thead = FALSE)
```
</center>
...
OMChem_Groups <- unique(OMChem_tab$Group)
  ...
  # column_spec(4, width_min = "15em") %>%
  row_spec(1:4, background = 'white')  %>%
 scroll_box(width = "770px", height = "20em",fixed_thead = FALSE)
```
</center>
<br>
...
qwqwqwqw
$SO_4^{2-}$ concentration was tied to salinity in Coorong. Is this permanent? What are the settings for this?
