...
\begin{equation}
\hat{f}_{sed}^{O_2} = \frac{\mathcal{F}_{atm}^{O_2}}{\Delta z_{bot}}                          
(\#eq:oxy6)
\end{equation}
...
The default variables created by this module, and the optionally required linked variables needed for full functionality of this module are summarised in Table X. The diagnostic outputs able to be output are summarised in Table Y.
...
The parameters and settings used by this module are summarised in Table X
