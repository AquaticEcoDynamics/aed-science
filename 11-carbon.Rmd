...
The constant coefficients in these options are provided in Table \@ref(tab:11-alkmode). A case study using alk_mode=5 in Brisbane River (link to case study) is given in Section 5.5. Users may wish to implement tailored alkalinity relationships as additional alk_mode options for specific study sites and use-cases.
