...
<caption>(\#tab:20-statevariables)State variables</caption>
 <thead>
  <tr>
...
<caption>(\#tab:20-parametersummmary)Diagnostics</caption>
 <thead>
  <tr>
...
<div style="border: 1px solid #ddd; padding: 5px; overflow-x: scroll; width:725px; "><table class="table table-hover" style="width: auto !important; margin-left: auto; margin-right: auto;">
<caption>(\#tab:20-parameterconfig)Parameters and configuration</caption>
 <thead>
  <tr>
