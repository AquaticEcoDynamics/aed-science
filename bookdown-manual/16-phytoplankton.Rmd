...
kable(parameter_summary,"html", escape = F, align = "c", caption = "Diagnostics",
  ...
  column_spec(6, width_min = "4em") %>%
  column_spec(7, width_min = "4em") %>%
  column_spec(8, width_min = "4em") %>%
  column_spec(9, width_min = "4em") %>%
  column_spec(10, width_min = "4em") %>%
  column_spec(11, width_min = "4em") %>%
  column_spec(12, width_min = "4em") %>%
  column_spec(13, width_min = "4em") %>%
  column_spec(14, width_min = "4em") %>%
  column_spec(15, width_min = "4em") %>%
  column_spec(16, width_min = "4em") %>%
  column_spec(17, width_min = "4em") %>%
  column_spec(18, width_min = "4em") %>%
  column_spec(19, width_min = "4em") %>%
  column_spec(20, width_min = "4em") %>%
  column_spec(21, width_min = "4em") %>%
  column_spec(22, width_min = "4em") %>%
  column_spec(23, width_min = "4em") %>%
  column_spec(24, width_min = "13em") %>%
